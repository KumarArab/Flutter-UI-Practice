          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  // right: SizeConfig.width! * 0.8 * 0.05 * 1,
                  top: SizeConfig.width! * 0.95,
                  child: Hero(
                    tag: "goldCard",
                    child: Card(
                      margin: EdgeInsets.zero,
                ...
                Positioned(
                  // right: SizeConfig.width! * 0.8 * 0.05 * 2,
                  top: SizeConfig.width! * 0.55,
                  child: Hero(
                    tag: "floCard",
                    child: Card(
                      margin: EdgeInsets.zero,
                ...
                Positioned(
                  // right: SizeConfig.width! * 0.8 * 0.05 * 3,
                  top: 0,
                  child: Hero(
                    tag: "rewardCard",
                    child: Card(
